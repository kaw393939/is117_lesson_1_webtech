...
- Typing forces your brain to notice patterns.

The bus metaphor (keep it simple)
- Bus = your VS Code workspace
- Steering wheel = file explorer
...
- Start here: [docs/lessons/00-start-here.md](docs/lessons/00-start-here.md)
- Do one step at a time.
- If you get stuck, ask for help with the exact error.
...
- All lessons are in [docs/lessons](docs/lessons).
- Start with the index: [docs/lessons/00-start-here.md](docs/lessons/00-start-here.md).
